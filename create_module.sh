...
import (
	"gamebook-backend/modules/$MODULE_NAME/service"
	"gamebook-backend/modules/$MODULE_NAME/validation"
...
import (
	"gamebook-backend/modules/$MODULE_NAME/repository"
	"gorm.io/gorm"
)
...
import (
	"gamebook-backend/modules/$MODULE_NAME/controller"
